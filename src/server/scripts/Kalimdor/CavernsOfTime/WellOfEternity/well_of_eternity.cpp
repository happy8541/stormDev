/*
 * Copyright (C) 2017 Stormscale.Ru Well_of_enernity.cpp Rewrite Instanse.
 * Начало работы с инстом.
 * Полная кодировка самого подземелья.
 * В следующей части будут переписанны боссы.
 * 
 */
